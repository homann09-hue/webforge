...
export const ONBOARDING_GATES: readonly OnboardingGate[] = [
  {
    id: "lead-qualified",
    label: "Anfrage geprüft",
    required: true,
    customerFacing: false,
    description: "Bedarf, Budget und grundsätzliche Passung sind geklärt.",
  },
  {
    id: "offer-accepted",
    ...
    required: true,
    customerFacing: true,
    description: "Leistungsumfang und Preis wurden bestätigt.",
  },
  {
    id: "deposit-confirmed",
    label: "Startzahlung bestätigt",
    required: true,
    customerFacing: true,
    description: "Die vereinbarte Startzahlung ist eingegangen oder anderweitig freigegeben.",
  },
  {
    id: "company-data",
    label: "Firmendaten vorhanden",
    required: true,
    customerFacing: true,
    description: "Firmenname, Ansprechpartner, Kontakt und Anschrift liegen vor.",
  },
  {
    id: "branding",
    label: "Logo und Erscheinungsbild",
    required: false,
    customerFacing: true,
    description: "Logo, Farben oder die Freigabe für ein neues Erscheinungsbild liegen vor.",
  },
  {
    id: "content",
    ...
    required: true,
    customerFacing: true,
    description: "Leistungen, Texte und verwendbare Bilder sind vorhanden oder zur Erstellung freigegeben.",
  },
  {
    id: "domain-access",
    label: "Domain-Zugang",
    required: true,
    customerFacing: true,
    description: "Domain ist registriert und DNS-Zugang bzw. Transfermöglichkeit liegt vor.",
  },
  {
    id: "legal-data",
    ...
    required: true,
    customerFacing: true,
    description: "Impressums- und Datenschutzangaben des Kunden sind vorhanden.",
  },
  {
    id: "site-configured",
    label: "Website konfiguriert",
    required: true,
    customerFacing: false,
    description: "Branche, Theme, Module und Inhalte sind in der SiteConfig vollständig erfasst.",
  },
  {
    id: "customer-review",
    label: "Kundenprüfung",
    required: true,
    customerFacing: true,
    description: "Der Kunde hat die Vorschau geprüft und Änderungswünsche abgearbeitet.",
  },
  {
    id: "launch-approved",
    label: "Livegang freigegeben",
    required: true,
    customerFacing: true,
    description: "Der Kunde hat den finalen Stand ausdrücklich zum Livegang freigegeben.",
  },
];
