 ...
 *
 * The production webhook is the Next.js route at
 * app/api/stripe/webhook/route.ts. The legacy Supabase function remains only
 * as migration history and is not part of the active runtime.
 *
