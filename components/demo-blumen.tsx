...
const bouquets = [
  { name: "Sonnenglück", price: 29, text: "Gelb, Apricot und Creme · locker und saisonal", colors: "linear-gradient(145deg,#ffd564,#ff9f74,#f9edd2)" },
  { name: "Rosé Atelier", price: 39, text: "Rosé, Mauve und feines Grün · ruhig und elegant", colors: "linear-gradient(145deg,#f4a7b9,#bd819e,#d5dec8)" },
  { name: "Wild & Frei", price: 34, text: "Kräftige Wiesenfarben · locker und lebendig", colors: "linear-gradient(145deg,#ff785f,#f6c84f,#8761a9)" },
  { name: "Pur Weiß", price: 42, text: "Creme, Weiß und Salbeigrün · modern und klar", colors: "linear-gradient(145deg,#fffdf2,#d9decf,#a5b19a)" },
];
    ...
    <main className={`${styles.demo} ${styles.flower}`}>
      <nav className={`${styles.nav} ${styles.shell}`}>
        ...
        <div className={styles.navActions}>
          <a className={styles.ghostButton} href="#atelier">Über das Atelier</a>
          <a className={styles.pill} href="#builder">Strauß planen ↗</a>
        </div>
      </nav>
      ...
      <section className={`${styles.hero} ${styles.shell}`} id="top">
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}>
            <a className={styles.solidButton} href="#builder">Strauß zusammenstellen ↗</a>
            <a className={styles.ghostButton} href="#collection">Sträuße ansehen</a>
          </div>
          <div className={styles.facts}>
            <div className={styles.fact}><b>2h</b><span>Abholung möglich</span></div>
            <div className={styles.fact}><b>4×</b><span>frische Ware pro Woche</span></div>
        ...
        <div className={`${styles.stage} ${styles.flowerStage}`}>
          <div className={styles.stageTop}>
            ...
            <span className={styles.live}><i />Frisch eingetroffen</span>
          </div>
          <div className={styles.stageCard}>
            <div><small>HEUTE IM ATELIER</small><b>Pfingstrosen · Levkojen · Wiesenmix</b></div>
            <strong>08:42</strong>
          </div>
        </div>
      </section>
        ...
        <div className={styles.shell}>
          <div className={styles.sectionHead}>
            ...
            <div>
              ...
              <p>Vier Beispiele mit klaren Farben und Preisen. Kunden sehen sofort, welcher Stil zu ihnen passt.</p>
            </div>
          </div>
        ...
        <div className={styles.shell}>
          <div className={styles.sectionHead}>
            ...
            <div>
              ...
              <p>
                Anlass, Größe, Stil und Farben auswählen. Die Vorschau und der Preis ändern sich sofort – einfach und
                verständlich.
              </p>
            </div>
          </div>
          <div className={styles.tool}>
            <div className={styles.toolPanel}>
              <div className={styles.moodGrid}>
                <div>
                  ...
                  <label>
                    <b style={{ display: "block", marginTop: 20, fontSize: 11, letterSpacing: ".1em", textTransform: "uppercase", color: "#a8b0bb" }}>
                      Farben
                    </b>
                  </label>
                ...
                <div
                  className={styles.previewBouquet}
                  style={
                    {
                      "--m1": builder.palette.colors[0],
                      "--m2": builder.palette.colors[1],
                      "--m3": builder.palette.colors[2],
                    } as React.CSSProperties
                  }
                >
                  <div className={styles.previewInfo}>
                    <div><small>{occasion.toUpperCase()} · {mood.toUpperCase()}</small><b>{builder.palette.name} · Größe {size}</b></div>
            ...
            <div className={styles.toolCopy}>
              ...
              <p>
                Der Strauß-Planer zeigt Stil, Farben und Preis direkt an. In einer echten Website könnte die Auswahl
                anschließend bestellt oder als Anfrage an das Atelier geschickt werden.
              </p>
              <div className={styles.result}>
                <small>IHRE AUSWAHL</small>
                <b>{builder.price} €</b>
                <p>{occasion} · {mood} · {builder.palette.name} · Größe {size}</p>
              </div>
              <button
          ...
          <div className={styles.grid3}>
            {[
              ...
              <article className={styles.card} key={n}>
                <div className={styles.cardNumber}><span>{n}</span><span>BLÜTENLIEBE</span></div>
                <h3>{title}</h3>
                <p>{text}</p>
              </article>
            ))}
      ...
      <footer className={`${styles.footer} ${styles.shell}`}>
        <div><strong>BLÜTENLIEBE</strong><br />Blumenatelier · Hildesheim</div>
