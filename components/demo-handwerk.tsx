    ...
    <main className={`${styles.demo} ${styles.craft}`}>
      <nav className={`${styles.nav} ${styles.shell}`}>
        ...
        <div className={styles.navActions}>
          ...
          <a className={styles.pill} href="#kontakt">Anfrage senden ↗</a>
        </div>
      </nav>
      ...
      <section className={`${styles.hero} ${styles.shell}`} id="top">
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}>
            ...
            <a className={styles.ghostButton} href="#projekte">Referenzen ansehen</a>
          </div>
          ...
          <div className={styles.grid4}>
            {services.map(([n, title, text, metric]) => (
              <article className={styles.card} key={title}>
                <div className={styles.cardNumber}><span>{n}</span><span>{metric} PASSEND</span></div>
                <h3>{title}</h3>
                <p>{text}</p>
        ...
        <div className={styles.shell}>
          ...
          <div className={styles.tool}>
            <div className={styles.toolCopy}>
              ...
              <div className={styles.facts}>
                <div className={styles.fact}><b>~20s</b><span>bis zum Ergebnis</span></div>
                <div className={styles.fact}><b>3</b><span>einfache Angaben</span></div>
            ...
            <div className={styles.toolPanel}>
              <div className={styles.field}>
                ...
                <div className={styles.rangeRow}>
                  <input id="hw-area" type="range" min="50" max="350" step="10" value={area} onChange={(event) => setArea(Number(event.target.value))} />
      ...
      <section className={styles.contact} id="kontakt">
        <div className={`${styles.shell} ${styles.contactGrid}`}>
          ...
          <form onSubmit={(event) => event.preventDefault()}>
            ...
            <label htmlFor="hw-topic">Worum geht es?<select id="hw-topic"><option>Dachsanierung</option><option>Flachdach</option><option>Reparatur</option><option>Dachfenster</option></select></label>
            <label htmlFor="hw-msg">Kurze Beschreibung<textarea id="hw-msg" rows={4} placeholder="Zum Beispiel: Dach ist undicht und soll komplett saniert werden." /></label>
